            ...
            for user in users:
                ...
                while added < total:
                    ...
                    if hasattr(response, 'Error'):
                        ...
                        ui_print("[plex] Standard watchlist failed, trying RSS fallback...", debug=ui_settings.debug)
                        rss_url = 'https://plex.tv/users/' + user[1] + '/watchlist.rss' # This is a guess, usually requires token in query
                        # Actually, let's try the old PMS endpoint which sometimes proxies correctly
                        # But we don't have a PMS address here necessarily.
                        # Let's just suppress the error if it's 404 and we can't do anything.
                        pass
